...
export class NavbarComponent implements OnInit, OnDestroy {
    ...
    getTitle() {
        ...
        return "GESTIÓN HOTELERA";
    }

    toggleCollapse() {
        this.isCollapsed = !this.isCollapsed;  // Cambiar el estado de colapso
    }

    toggleDropdown() {
        this.isDropdownOpen = !this.isDropdownOpen;  // Cambiar el estado del dropdown
